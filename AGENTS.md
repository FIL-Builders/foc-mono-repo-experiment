...
Agents may make focused changes on topic branches and open PRs. They may not alter tracker issues, transfer repositories or package ownership, enable telemetry, change network defaults, handle signer secrets, make irreversible/paid actions, request reviewers, or merge. Keep adapters dependent on Filecoin Pin public/core seams only.
